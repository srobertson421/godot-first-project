...
func subscribe(event_key, listener)->void:
	"""
...
func unsubscribe(listener, event_key = null)->void:
	"""
...
func publish(event_key, payload = null)->void:
	"""
...
func publish_to_random(event_key:String, payload)->void:
	"""
...
func publish_async(event_key, payload)->void:
	"""
...
func subscribe_instant(event_key, listener)->void:
	"""
...
func unsubscribe_instant(listener, event_key = null)->void:
	"""
...
func publish_instant(event_key, payload)->Array:
	"""
...
func register_service(service_id:int, provider)->void:
	"""
...
func get_service(service_id:int):
	"""
...
func clear_instant_events()->void:
	"""
